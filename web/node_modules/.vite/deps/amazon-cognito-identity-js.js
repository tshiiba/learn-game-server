import { a as __toCommonJS, i as __require, n as __esmMin, o as __toESM, r as __exportAll, t as __commonJSMin } from "./chunk-olfrzTEO.js";
//#region node_modules/amazon-cognito-identity-js/es/AuthenticationDetails.js
/*!
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/utils/cryptoSecureRandomInt.js
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/utils/WordArray.js
/**
...
//#endregion
//#region node_modules/@aws-crypto/sha256-js/node_modules/tslib/tslib.es6.js
...
//#endregion
//#region node_modules/@aws-crypto/sha256-js/build/constants.js
...
//#endregion
//#region node_modules/@aws-crypto/sha256-js/build/RawSha256.js
var require_RawSha256 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.RawSha256 = void 0;
	var constants_1 = require_constants();
	exports.RawSha256 = function() {
		function RawSha256() {
...
//#endregion
//#region node_modules/@aws-sdk/util-utf8-browser/dist-es/pureJs.js
var fromUtf8$2, toUtf8$2;
var init_pureJs = __esmMin((() => {
	fromUtf8$2 = (input) => {
		const bytes = [];
		for (let i = 0, len = input.length; i < len; i++) {
			const value = input.charCodeAt(i);
			if (value < 128) bytes.push(value);
			else if (value < 2048) bytes.push(value >> 6 | 192, value & 63 | 128);
		...
		for (let i = 0, len = input.length; i < len; i++) {
			...
			if (byte < 128) decoded += String.fromCharCode(byte);
				...
				const encoded = "%" + [
					...
					input[++i],
					input[++i]
				].map((byteValue) => byteValue.toString(16)).join("%");
...
//#endregion
//#region node_modules/@aws-sdk/util-utf8-browser/dist-es/whatwgEncodingApi.js
...
var init_whatwgEncodingApi = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/util-utf8-browser/dist-es/index.js
...
var init_dist_es = __esmMin((() => {
	...
	fromUtf8 = (input) => typeof TextEncoder === "function" ? fromUtf8$1(input) : fromUtf8$2(input);
	toUtf8 = (input) => typeof TextDecoder === "function" ? toUtf8$1(input) : toUtf8$2(input);
}));
//#endregion
//#region node_modules/@aws-crypto/util/build/convertToBuffer.js
...
//#endregion
//#region node_modules/@aws-crypto/util/build/isEmptyData.js
...
//#endregion
//#region node_modules/@aws-crypto/util/build/numToUint8.js
...
//#endregion
//#region node_modules/@aws-crypto/util/build/uint32ArrayFrom.js
...
//#endregion
//#region node_modules/@aws-crypto/util/build/index.js
...
//#endregion
//#region node_modules/@aws-crypto/sha256-js/build/jsSha256.js
var require_jsSha256 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Sha256 = void 0;
	var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
	var constants_1 = require_constants();
	var RawSha256_1 = require_RawSha256();
	var util_1 = require_build$1();
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/BigInteger.js
var import_build = (/* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	(0, (init_tslib_es6(), __toCommonJS(tslib_es6_exports)).__exportStar)(require_jsSha256(), exports);
})))();
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/AuthenticationHelper.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var AuthenticationHelper = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.generateRandomSmallA = function generateRandomSmallA() {
		return new BigInteger_default(randomBytes(128).toString("hex"), 16);
	};
	...
	_proto.calculateA = function calculateA(a, callback) {
		...
		this.g.modPow(a, this.N, function(err, A) {
			if (err) callback(err, null);
			if (A.mod(_this3.N).equals(BigInteger_default.ZERO)) callback(/* @__PURE__ */ new Error("Illegal paramater. A mod N cannot be 0."), null);
			callback(null, A);
		});
	};
	_proto.calculateU = function calculateU(A, B) {
		this.UHexHash = this.hexHash(this.padHex(A) + this.padHex(B));
		return new BigInteger_default(this.UHexHash, 16);
	};
	_proto.hash = function hash(buf) {
		var awsCryptoHash = new import_build.Sha256();
	...
	_proto.computehkdf = function computehkdf(ikm, salt) {
		...
		var awsCryptoHash = new import_build.Sha256(salt);
		awsCryptoHash.update(ikm);
		var awsCryptoHashHmac = new import_build.Sha256(awsCryptoHash.digestSync());
		awsCryptoHashHmac.update(infoBitsBuffer);
		return awsCryptoHashHmac.digestSync().slice(0, 16);
	};
	_proto.getPasswordAuthenticationKey = function getPasswordAuthenticationKey(username, password, serverBValue, salt, callback) {
		var _this4 = this;
		if (serverBValue.mod(this.N).equals(BigInteger_default.ZERO)) throw new Error("B cannot be zero.");
		this.UValue = this.calculateU(this.largeAValue, serverBValue);
		if (this.UValue.equals(BigInteger_default.ZERO)) throw new Error("U cannot be zero.");
		var usernamePassword = "" + this.poolName + username + ":" + password;
		var usernamePasswordHash = this.hash(usernamePassword);
		var xValue = new BigInteger_default(this.hexHash(this.padHex(salt) + usernamePasswordHash), 16);
		this.calculateS(xValue, serverBValue, function(err, sValue) {
			if (err) callback(err, null);
			callback(null, _this4.computehkdf(import_buffer.Buffer.from(_this4.padHex(sValue), "hex"), import_buffer.Buffer.from(_this4.padHex(_this4.UValue), "hex")));
		});
	};
	_proto.calculateS = function calculateS(xValue, serverBValue, callback) {
		...
		this.g.modPow(xValue, this.N, function(err, gModPowXN) {
			if (err) callback(err, null);
			serverBValue.subtract(_this5.k.multiply(gModPowXN)).modPow(_this5.smallAValue.add(_this5.UValue.multiply(xValue)), _this5.N, function(err2, result) {
	...
	_proto.padHex = function padHex(bigInt) {
		if (!(bigInt instanceof BigInteger_default)) throw new Error("Not a BigInteger");
		var isNegative = bigInt.compareTo(BigInteger_default.ZERO) < 0;
		var hexStr = bigInt.abs().toString(16);
		hexStr = hexStr.length % 2 !== 0 ? "0" + hexStr : hexStr;
		hexStr = HEX_MSB_REGEX.test(hexStr) ? "00" + hexStr : hexStr;
		if (isNegative) {
			hexStr = new BigInteger_default(hexStr.split("").map(function(x) {
				var invertedNibble = ~parseInt(x, 16) & 15;
				return "0123456789ABCDEF".charAt(invertedNibble);
			}).join(""), 16).add(BigInteger_default.ONE).toString(16);
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoJwtToken.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var CognitoJwtToken = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.decodePayload = function decodePayload() {
		...
		try {
			return JSON.parse(import_buffer.Buffer.from(payload, "base64").toString("utf8"));
		} catch (err) {
			return {};
		}
	};
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoAccessToken.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var CognitoAccessToken = /* @__PURE__ */ function(_CognitoJwtToken) {
	...
	*/
	function CognitoAccessToken(_temp) {
		var AccessToken = (_temp === void 0 ? {} : _temp).AccessToken;
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoIdToken.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var CognitoIdToken = /* @__PURE__ */ function(_CognitoJwtToken) {
	...
	*/
	function CognitoIdToken(_temp) {
		var IdToken = (_temp === void 0 ? {} : _temp).IdToken;
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoRefreshToken.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var CognitoRefreshToken = /* @__PURE__ */ function() {
	...
	*/
	function CognitoRefreshToken(_temp) {
		this.token = (_temp === void 0 ? {} : _temp).RefreshToken || "";
	}
	/**
	* @returns {string} the record's token.
	*/
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoUserSession.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var CognitoUserSession = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.calculateClockDrift = function calculateClockDrift() {
		return Math.floor(/* @__PURE__ */ new Date() / 1e3) - Math.min(this.accessToken.getIssuedAt(), this.idToken.getIssuedAt());
	};
	_proto.isValid = function isValid() {
		var adjusted = Math.floor(/* @__PURE__ */ new Date() / 1e3) - this.clockDrift;
		return adjusted < this.accessToken.getExpiration() && adjusted < this.idToken.getExpiration();
	};
	return CognitoUserSession;
}();
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/DateHelper.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoUserAttribute.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/StorageHelper.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoUser.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
var userAgent = typeof navigator !== "undefined" ? Platform.isReactNative ? "react-native" : navigator.userAgent : "nodejs";
/** @class */
var CognitoUser = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.authenticateUser = function authenticateUser(authDetails, callback) {
		...
		return callback.onFailure(/* @__PURE__ */ new Error("Authentication flow type is invalid."));
	};
		...
		authenticationHelper.getLargeAValue(function(errOnAValue, aValue) {
			...
			_this2.client.request("InitiateAuth", jsonReq, function(err, data) {
				...
				authenticationHelper.getPasswordAuthenticationKey(_this2.username, authDetails.getPassword(), serverBValue, salt, function(errOnHkdf, hkdf) {
					...
					var concatBuffer = import_buffer.Buffer.concat([
						import_buffer.Buffer.from(_this2.pool.getUserPoolName(), "utf8"),
						import_buffer.Buffer.from(_this2.username, "utf8"),
						import_buffer.Buffer.from(challengeParameters.SECRET_BLOCK, "base64"),
						import_buffer.Buffer.from(dateNow, "utf8")
					]);
					var awsCryptoHash = new import_build.Sha256(hkdf);
					awsCryptoHash.update(concatBuffer);
					var resultFromAWSCrypto = awsCryptoHash.digestSync();
					var signatureString = import_buffer.Buffer.from(resultFromAWSCrypto).toString("base64");
	...
	_proto.authenticateUserPlainUsernamePassword = function authenticateUserPlainUsernamePassword(authDetails, callback) {
		...
		if (!authParameters.PASSWORD) {
			callback.onFailure(/* @__PURE__ */ new Error("PASSWORD parameter is required"));
			return;
		}
		var authenticationHelper = new AuthenticationHelper(this.pool.getUserPoolName());
	...
	_proto.authenticateUserInternal = function authenticateUserInternal(dataAuthenticate, authenticationHelper, callback) {
		...
		authenticationHelper.generateHashDevice(dataAuthenticate.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey, dataAuthenticate.AuthenticationResult.NewDeviceMetadata.DeviceKey, function(errGenHash) {
			...
			var deviceSecretVerifierConfig = {
				Salt: import_buffer.Buffer.from(authenticationHelper.getSaltDevices(), "hex").toString("base64"),
				PasswordVerifier: import_buffer.Buffer.from(authenticationHelper.getVerifierDevices(), "hex").toString("base64")
			};
	...
	_proto.completeNewPasswordChallenge = function completeNewPasswordChallenge(newPassword, requiredAttributeData, callback, clientMetadata) {
		var _this5 = this;
		if (!newPassword) return callback.onFailure(/* @__PURE__ */ new Error("New password is required."));
		var authenticationHelper = new AuthenticationHelper(this.pool.getUserPoolName());
		var userAttributesPrefix = authenticationHelper.getNewPasswordRequiredChallengeUserAttributePrefix();
		...
		authenticationHelper.getLargeAValue(function(errAValue, aValue) {
			...
			_this6.client.request("RespondToAuthChallenge", jsonReq, function(err, data) {
				...
				authenticationHelper.getPasswordAuthenticationKey(_this6.deviceKey, _this6.randomPassword, serverBValue, salt, function(errHkdf, hkdf) {
					...
					var dateNow = dateHelper.getNowString();
					var concatBuffer = import_buffer.Buffer.concat([
						import_buffer.Buffer.from(_this6.deviceGroupKey, "utf8"),
						import_buffer.Buffer.from(_this6.deviceKey, "utf8"),
						import_buffer.Buffer.from(challengeParameters.SECRET_BLOCK, "base64"),
						import_buffer.Buffer.from(dateNow, "utf8")
					]);
					var awsCryptoHash = new import_build.Sha256(hkdf);
	...
	_proto.sendMFACode = function sendMFACode(confirmationCode, callback, mfaType, clientMetadata) {
		...
		this.client.request("RespondToAuthChallenge", jsonReq, function(err, dataAuthenticate) {
			if (err) return callback.onFailure(err);
			if (dataAuthenticate.ChallengeName === "DEVICE_SRP_AUTH") {
	...
	_proto.changePassword = function changePassword(oldUserPassword, newUserPassword, callback, clientMetadata) {
		if (!(this.signInUserSession != null && this.signInUserSession.isValid())) return callback(/* @__PURE__ */ new Error("User is not authenticated"), null);
	...
	_proto.getUserAttributes = function getUserAttributes(callback) {
		if (!(this.signInUserSession != null && this.signInUserSession.isValid())) return callback(/* @__PURE__ */ new Error("User is not authenticated"), null);
		this.client.request("GetUser", { AccessToken: this.signInUserSession.getAccessToken().getJwtToken() }, function(err, userData) {
			if (err) return callback(err, null);
			var attributeList = [];
			for (var i = 0; i < userData.UserAttributes.length; i++) {
				var userAttribute = new CognitoUserAttribute({
	...
	_proto.getUserData = function getUserData(callback, params) {
		...
		if (!(this.signInUserSession != null && this.signInUserSession.isValid())) {
			this.clearCachedUserData();
			return callback(/* @__PURE__ */ new Error("User is not authenticated"), null);
		}
	...
	_proto.isFetchUserDataAndTokenRequired = function isFetchUserDataAndTokenRequired(params) {
		var _ref$bypassCache = (params || {}).bypassCache;
		return _ref$bypassCache === void 0 ? false : _ref$bypassCache;
	};
	...
	_proto.getSession = function getSession(callback, options) {
		if (options === void 0) options = {};
		if (this.username == null) return callback(/* @__PURE__ */ new Error("Username is null. Cannot retrieve a new session"), null);
		...
		if (this.storage.getItem(idTokenKey)) {
			var idToken = new CognitoIdToken({ IdToken: this.storage.getItem(idTokenKey) });
			var accessToken = new CognitoAccessToken({ AccessToken: this.storage.getItem(accessTokenKey) });
			var refreshToken = new CognitoRefreshToken({ RefreshToken: this.storage.getItem(refreshTokenKey) });
			var cachedSession = new CognitoUserSession({
				IdToken: idToken,
				AccessToken: accessToken,
				RefreshToken: refreshToken,
				ClockDrift: parseInt(this.storage.getItem(clockDriftKey), 0) || 0
			});
			if (cachedSession.isValid()) {
				this.signInUserSession = cachedSession;
				return callback(null, this.signInUserSession);
			}
			if (!refreshToken.getToken()) return callback(/* @__PURE__ */ new Error("Cannot retrieve a new session. Please authenticate."), null);
			this.refreshSession(refreshToken, callback, options.clientMetadata);
		} else callback(/* @__PURE__ */ new Error("Local storage is missing an ID Token, Please authenticate"), null);
	};
	...
	_proto.getCognitoUserSession = function getCognitoUserSession(authResult) {
		return new CognitoUserSession({
			IdToken: new CognitoIdToken(authResult),
			AccessToken: new CognitoAccessToken(authResult),
			RefreshToken: new CognitoRefreshToken(authResult)
		});
	};
	...
	_proto.getAttributeVerificationCode = function getAttributeVerificationCode(attributeName, callback, clientMetadata) {
		if (this.signInUserSession == null || !this.signInUserSession.isValid()) return callback.onFailure(/* @__PURE__ */ new Error("User is not authenticated"));
	...
	_proto.globalSignOut = function globalSignOut(callback) {
		var _this17 = this;
		if (this.signInUserSession == null || !this.signInUserSession.isValid()) return callback.onFailure(/* @__PURE__ */ new Error("User is not authenticated"));
		this.client.request("GlobalSignOut", { AccessToken: this.signInUserSession.getAccessToken().getJwtToken() }, function(err) {
			if (err) return callback.onFailure(err);
	...
	_proto.revokeTokens = function revokeTokens(revokeTokenCallback) {
		...
		if (!this.signInUserSession) return revokeTokenCallback(/* @__PURE__ */ new Error("User is not authenticated"));
		if (!this.signInUserSession.getAccessToken()) return revokeTokenCallback(/* @__PURE__ */ new Error("No Access token available"));
	...
	_proto.isSessionRevocable = function isSessionRevocable(token) {
		if (token && typeof token.decodePayload === "function") try {
			return !!token.decodePayload().origin_jti;
		} catch (err) {}
		return false;
	};
	...
	_proto.associateSoftwareToken = function associateSoftwareToken(callback) {
		var _this20 = this;
		if (!(this.signInUserSession != null && this.signInUserSession.isValid())) this.client.request("AssociateSoftwareToken", { Session: this.Session }, function(err, data) {
			if (err) return callback.onFailure(err);
			_this20.Session = data.Session;
			return callback.associateSecretCode(data.SecretCode);
		});
		else this.client.request("AssociateSoftwareToken", { AccessToken: this.signInUserSession.getAccessToken().getJwtToken() }, function(err, data) {
			if (err) return callback.onFailure(err);
			return callback.associateSecretCode(data.SecretCode);
		});
	};
...
//#endregion
//#region node_modules/unfetch/dist/unfetch.module.js
var unfetch_module_exports = /* @__PURE__ */ __exportAll({ default: () => unfetch_module_default });
...
var init_unfetch_module = __esmMin((() => {}));
...
var getAmplifyUserAgent = function getAmplifyUserAgent(action) {
	...
	return "" + UserAgent.prototype.userAgent + uaCategoryAction + uaFramework;
};
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/Client.js
...
var Client = /* @__PURE__ */ function() {
	...
	*/
	function Client(region, endpoint, fetchOptions) {
		...
		var credentials = (fetchOptions || {}).credentials;
	...
	*/
	...
	_proto.requestWithRetry = function requestWithRetry(operation, params, callback) {
		...
		}, [params], 5 * 1e3).then(function(result) {
			return callback(null, result);
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CognitoUserPool.js
/*!
* Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
* SPDX-License-Identifier: Apache-2.0
*/
...
var CognitoUserPool = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.getCurrentUser = function getCurrentUser() {
		...
		if (lastAuthUser) return new CognitoUser({
...
//#endregion
//#region node_modules/amazon-cognito-identity-js/es/CookieStorage.js
...
var CookieStorage = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.setItem = function setItem(key, value) {
		...
		import_js_cookie.set(key, value, options);
		return import_js_cookie.get(key);
	};
	...
	_proto.removeItem = function removeItem(key) {
		...
		if (this.sameSite) options.sameSite = this.sameSite;
		return import_js_cookie.remove(key, options);
	};
	_proto.clear = function clear() {
		var cookies = import_js_cookie.get();
...
//#endregion
export { AuthenticationDetails, AuthenticationHelper, CognitoAccessToken, CognitoIdToken, CognitoRefreshToken, CognitoUser, CognitoUserAttribute, CognitoUserPool, CognitoUserSession, CookieStorage, DateHelper, WordArray, appendToCognitoUserAgent };
